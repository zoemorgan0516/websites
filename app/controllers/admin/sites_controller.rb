class Admin::SitesController < BaseController
  ...
  def site_params
    params.require(:site).permit(:cooperation_url, :avatar, :name, :domain, :slider_string1, :slider_string2, :slider_string3,:cooperation_string, footer_attributes: [ :avatar, :company_number, :company_address ])
  end
end
